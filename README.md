# OpenProject Terraform - Provision an EKS Cluster

This repo is a companion repo from the [Provision an EKS Cluster learn guide](https://learn.hashicorp.com/terraform/kubernetes/provision-eks-cluster), containing
